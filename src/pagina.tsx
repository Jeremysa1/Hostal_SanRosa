    ...
    return (
        <>
            <div className="Pagina-imagen">
                <img src="https://res.cloudinary.com/dfznn7pui/image/upload/v1761079649/termales-santa-2_wzlgap.jpg"className='imagen-escritorio' alt="Termales Santa Rosa" />
